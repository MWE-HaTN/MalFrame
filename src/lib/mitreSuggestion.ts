...
// ── Structured tag rules for MRE RuntimeBehaviorData ──────────────────────
...
const ANTI_DEBUG_TAG_RULES: TagRule[] = [
  { tag: "API-based", techniqueId: "T1622", techniqueName: "Debugger Evasion", tacticId: "defense_evasion", confidence: "high" },
  { tag: "Exception-based", techniqueId: "T1622", techniqueName: "Debugger Evasion", tacticId: "defense_evasion", confidence: "high" },
  { tag: "Timing-based", techniqueId: "T1622", techniqueName: "Debugger Evasion", tacticId: "defense_evasion", confidence: "high" },
  { tag: "Process/Thread-based", techniqueId: "T1622", techniqueName: "Debugger Evasion", tacticId: "defense_evasion", confidence: "high" },
  { tag: "Hardware Breakpoint Detection", techniqueId: "T1622", techniqueName: "Debugger Evasion", tacticId: "defense_evasion", confidence: "high" },
  { tag: "Memory Inspection", techniqueId: "T1622", techniqueName: "Debugger Evasion", tacticId: "defense_evasion", confidence: "high" },
  { tag: "PEB/NT Headers Check", techniqueId: "T1622", techniqueName: "Debugger Evasion", tacticId: "defense_evasion", confidence: "high" },
  { tag: "Instruction-level Checks", techniqueId: "T1622", techniqueName: "Debugger Evasion", tacticId: "defense_evasion", confidence: "high" },
  { tag: "Behavioral/Environment Checks", techniqueId: "T1622", techniqueName: "Debugger Evasion", tacticId: "defense_evasion", confidence: "high" },
];

const ANTI_VM_TAG_RULES: TagRule[] = [
  { tag: "BIOS", techniqueId: "T1497.001", techniqueName: "Virtualization/Sandbox Evasion: System Checks", tacticId: "discovery", confidence: "high" },
  { tag: "MAC", techniqueId: "T1497.001", techniqueName: "Virtualization/Sandbox Evasion: System Checks", tacticId: "discovery", confidence: "high" },
  { tag: "Registry", techniqueId: "T1497.001", techniqueName: "Virtualization/Sandbox Evasion: System Checks", tacticId: "discovery", confidence: "high" },
  { tag: "Driver", techniqueId: "T1497.001", techniqueName: "Virtualization/Sandbox Evasion: System Checks", tacticId: "discovery", confidence: "high" },
  { tag: "CPU Count", techniqueId: "T1497.001", techniqueName: "Virtualization/Sandbox Evasion: System Checks", tacticId: "discovery", confidence: "high" },
  { tag: "Sandbox Username", techniqueId: "T1497.001", techniqueName: "Virtualization/Sandbox Evasion: System Checks", tacticId: "discovery", confidence: "high" },
  { tag: "Hardware Fingerprint", techniqueId: "T1497.001", techniqueName: "Virtualization/Sandbox Evasion: System Checks", tacticId: "discovery", confidence: "high" },
  { tag: "Timing", techniqueId: "T1497.001", techniqueName: "Virtualization/Sandbox Evasion: System Checks", tacticId: "discovery", confidence: "high" },
];

const PERSISTENCE_TAG_RULES: TagRule[] = [
  { tag: "RunKey", techniqueId: "T1547.001", techniqueName: "Boot or Logon Autostart Execution: Registry Run Keys / Startup Folder", tacticId: "persistence", confidence: "high" },
  { tag: "StartupFolder", techniqueId: "T1547.001", techniqueName: "Boot or Logon Autostart Execution: Registry Run Keys / Startup Folder", tacticId: "persistence", confidence: "high" },
  { tag: "Service", techniqueId: "T1543.003", techniqueName: "Create or Modify System Process: Windows Service", tacticId: "persistence", confidence: "high" },
  { tag: "Task", techniqueId: "T1053.005", techniqueName: "Scheduled Task/Job: Scheduled Task", tacticId: "persistence", confidence: "high" },
  { tag: "WMI", techniqueId: "T1546.003", techniqueName: "Event Triggered Execution: WMI Event Subscription", tacticId: "persistence", confidence: "high" },
  { tag: "DLL Hijack", techniqueId: "T1574.001", techniqueName: "Hijack Execution Flow: DLL Search Order Hijacking", tacticId: "persistence", confidence: "high" },
  { tag: "COM Hijack", techniqueId: "T1546.015", techniqueName: "Event Triggered Execution: COM Object Hijacking", tacticId: "persistence", confidence: "high" },
];

const NETWORK_TAG_RULES: TagRule[] = [
  { tag: "C2", techniqueId: "T1071", techniqueName: "Application Layer Protocol", tacticId: "command_and_control", confidence: "high" },
  { tag: "DNS", techniqueId: "T1071.004", techniqueName: "Application Layer Protocol: DNS", tacticId: "command_and_control", confidence: "high" },
  { tag: "TLS", techniqueId: "T1573", techniqueName: "Encrypted Channel", tacticId: "command_and_control", confidence: "high" },
  { tag: "HTTP POST", techniqueId: "T1071.001", techniqueName: "Application Layer Protocol: Web Protocols", tacticId: "command_and_control", confidence: "high" },
  { tag: "Exfil", techniqueId: "T1041", techniqueName: "Exfiltration Over C2 Channel", tacticId: "exfiltration", confidence: "high" },
  { tag: "Beacon", techniqueId: "T1071", techniqueName: "Application Layer Protocol", tacticId: "command_and_control", confidence: "high" },
  { tag: "DGA", techniqueId: "T1568.002", techniqueName: "Dynamic Resolution: Domain Generation Algorithms", tacticId: "command_and_control", confidence: "high" },
];

const MEMORY_TAG_RULES: TagRule[] = [
  { tag: "RWX", techniqueId: "T1055", techniqueName: "Process Injection", tacticId: "defense_evasion", confidence: "high" },
  { tag: "Shellcode", techniqueId: "T1055", techniqueName: "Process Injection", tacticId: "defense_evasion", confidence: "high" },
  { tag: "Unpacked Module", techniqueId: "T1027.002", techniqueName: "Obfuscated Files or Information: Software Packing", tacticId: "defense_evasion", confidence: "high" },
  { tag: "Injection", techniqueId: "T1055", techniqueName: "Process Injection", tacticId: "defense_evasion", confidence: "high" },
  { tag: "Heap Spray", techniqueId: "T1055", techniqueName: "Process Injection", tacticId: "defense_evasion", confidence: "high" },
  { tag: "ROP", techniqueId: "T1055", techniqueName: "Process Injection", tacticId: "defense_evasion", confidence: "medium" },
];

const INJECTION_TAG_RULES: TagRule[] = [
  { tag: "Hollowing", techniqueId: "T1055.012", techniqueName: "Process Injection: Process Hollowing", tacticId: "defense_evasion", confidence: "high" },
  { tag: "Classic", techniqueId: "T1055.001", techniqueName: "Process Injection: Dynamic-link Library Injection", tacticId: "defense_evasion", confidence: "high" },
  { tag: "APC", techniqueId: "T1055.004", techniqueName: "Process Injection: Asynchronous Procedure Call", tacticId: "defense_evasion", confidence: "high" },
  { tag: "Doppelganging", techniqueId: "T1055.013", techniqueName: "Process Injection: Process Doppelgänging", tacticId: "defense_evasion", confidence: "high" },
  { tag: "Thread Hijack", techniqueId: "T1055.003", techniqueName: "Process Injection: Thread Execution Hijacking", tacticId: "defense_evasion", confidence: "high" },
  { tag: "DLL Injection", techniqueId: "T1055.001", techniqueName: "Process Injection: Dynamic-link Library Injection", tacticId: "defense_evasion", confidence: "high" },
  { tag: "Reflective", techniqueId: "T1620", techniqueName: "Reflective Code Loading", tacticId: "defense_evasion", confidence: "high" },
];

const ARTIFACT_TAG_RULES: TagRule[] = [
  { tag: "Registry", techniqueId: "T1112", techniqueName: "Modify Registry", tacticId: "defense_evasion", confidence: "high" },
  { tag: "Mutex", techniqueId: "T1055", techniqueName: "Process Injection", tacticId: "defense_evasion", confidence: "low" },
  { tag: "Service", techniqueId: "T1543.003", techniqueName: "Create or Modify System Process: Windows Service", tacticId: "persistence", confidence: "high" },
];

/**
 * Matches tags from entries against a rule set.
 */
...
/**
 * Suggests MITRE techniques from MRE RuntimeBehaviorData structured tags.
 */
export function suggestMitreFromMreRuntime(runtime: MreRuntimeLike): MitreSuggestion[] {
  const allSuggestions: MitreSuggestion[] = [
    ...matchTagRules(
      runtime.antiDebug.map((e) => ({ tags: e.categoryTags })),
      ANTI_DEBUG_TAG_RULES,
      "antiDebug",
    ),
    ...matchTagRules(
